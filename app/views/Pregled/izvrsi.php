...
<?php 
 ...
 foreach ($DATA['bla'] as $b ):
     echo '<label class="col-12 col-form-label mt-4 stil mb-4"><h3 class="ml-3" >  Zub - '. $b . '</h3></label>';
    foreach ($DATA['pregledi'] as $pregled):
        echo '<br>';
//        echo '<input type="checkbox" class="check2" name = "check_List[]" value="' . $b . '_' . $pregled->usluga_id . '"/>' . $pregled->naziv;
