...
<main class="container">
    <div class="row">
        <nav class="list-group col-12 col-sm-12 col-md-3 col-lg-2">
            <a href="<?php echo Configuration::BASE_URL; ?>usluge/" class="list-group-item active2">SVE</a>
            <?php
...
if (is_array($temp))
    foreach ($temp as $listaUslugaPoKateoriji):
        ...
        <?php echo $listaUslugaPoKateoriji->naziv; ?><br>
                                ...
                                <div class="modal fade" id="myModal<?php echo htmlspecialchars($listaUslugaPoKateoriji->usluga_id); ?>" role="dialog"  aria-hidden="true">
