            ...
            <div id="login">
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 "> 
                        ...
                        <h2 class="adminlogin"><strong>ADMINISTRATOR</strong></h2>
                        ...
                        <form method="post" id="login-form" autocomplete="on">
                            ...
                            <h5 class="mb-4"style="color: red;"><?php echo htmlspecialchars($DATA['message']); ?></h5>
                            <?php endif; ?>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-custom">Pošalji</button>
                        </div>
                    </div>
                </div>
            </div>
